...
export const SelectTable = () => {
  ...
  const getState = (state) => {
    ...
    return <>
          <button className="singletable" id="singletable" onClick={() => getState('singletable')}>
          ...
          <button className="doubletable" id="doubletable" onClick={() => getState('doubletable')}>
          ...
          <button className="bartable" id="bartable" onClick={() => getState('bartable')}>
            <img className="img_bartable" src={img_bartable} alt="bartable"/>
            <label className="label_bartable" htmlFor="table"> 바 테이블(n인) </label>
          </button>
          <button className="anything" id="bartable" onClick={() => getState('anything')}>
